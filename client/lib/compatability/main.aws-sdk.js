...
apigClientFactory.newClient = function (config) {
    ...
    var endpoint = 'https://gwet5nyzt5.execute-api.us-east-1.amazonaws.com/alpha';
    var parser = document.createElement('a');
    ...
    apigClient.billingRestaurantNameGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['restaurant-name'], ['body']);
        
        var billingRestaurantNameGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/billing/{restaurant-name}').expand(apiGateway.core.utils.parseParametersToObject(params, ['restaurant-name'])),
        ...
        return apiGatewayClient.makeRequest(billingRestaurantNameGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.billingRestaurantNameOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var billingRestaurantNameOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/billing/{restaurant-name}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(billingRestaurantNameOptionsRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.constraintsGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['keywords'], ['body']);
        
        var constraintsGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/constraints').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['keywords']),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(constraintsGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.constraintsConstraintNameGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['constraint-name'], ['body']);
        
        var constraintsConstraintNameGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/constraints/{constraint-name}').expand(apiGateway.core.utils.parseParametersToObject(params, ['constraint-name'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(constraintsConstraintNameGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.restaurantsGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['limit'], ['body']);
        
        var restaurantsGetRequest = {
            verb: 'get'.toUpperCase(),
        ...
        return apiGatewayClient.makeRequest(restaurantsGetRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.restaurantsRestaurantNameGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['restaurant-name'], ['body']);
        
        var restaurantsRestaurantNameGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/restaurants/{restaurant-name}').expand(apiGateway.core.utils.parseParametersToObject(params, ['restaurant-name'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(restaurantsRestaurantNameGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.restaurantsRestaurantNameOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var restaurantsRestaurantNameOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/restaurants/{restaurant-name}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(restaurantsRestaurantNameOptionsRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.restaurantsRestaurantNameTypeOfMenuGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['returnBoth', 'specialConstraints', 'type-of-menu', 'substitutions', 'nutritionInfo', 'restaurant-name', 'allow', 'constraints'], ['body']);
        
        var restaurantsRestaurantNameTypeOfMenuGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/restaurants/{restaurant-name}/{type-of-menu}').expand(apiGateway.core.utils.parseParametersToObject(params, ['type-of-menu', 'restaurant-name', ])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['returnBoth', 'specialConstraints', 'substitutions', 'nutritionInfo', 'allow', 'constraints']),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(restaurantsRestaurantNameTypeOfMenuGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.restaurantsRestaurantNameTypeOfMenuOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var restaurantsRestaurantNameTypeOfMenuOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/restaurants/{restaurant-name}/{type-of-menu}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(restaurantsRestaurantNameTypeOfMenuOptionsRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.updateRestaurantNamePost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['restaurant-id', 'contact-email', 'menus', 'monthly-bill', 'restaurant-name', 'billing-plan', 'primary-contact', 'phone', 'location'], ['body']);
        
        var updateRestaurantNamePostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/update/{restaurant-name}').expand(apiGateway.core.utils.parseParametersToObject(params, ['restaurant-name', ])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['restaurant-id', 'contact-email', 'menus', 'monthly-bill', 'billing-plan', 'primary-contact', 'phone', 'location']),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(updateRestaurantNamePostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.updateRestaurantNameItemPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['soy', 'wheat', 'vegetarian', 'menus', 'name', 'dairy', 'eggs', 'gluten-free', 'id', 'peanuts', 'vegan', 'category', 'treenuts', 'shared-fryer', 'shellfish', 'restaurant-name', 'components', 'fish', 'ingredients'], ['body']);
        
        var updateRestaurantNameItemPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/update/{restaurant-name}/item').expand(apiGateway.core.utils.parseParametersToObject(params, ['restaurant-name', ])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['soy', 'wheat', 'vegetarian', 'menus', 'name', 'dairy', 'eggs', 'gluten-free', 'id', 'peanuts', 'vegan', 'category', 'treenuts', 'shared-fryer', 'shellfish', 'components', 'fish', 'ingredients']),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(updateRestaurantNameItemPostRequest, authType, additionalParams, config.apiKey);
    };
